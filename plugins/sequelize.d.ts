 ...
 * @param strict defines whether or not to throw when the value is not an instance of DateOnly
 * @returns the necessary sequelize configuration for the property to work with DATEONLY
 */
export function dateOnlyColumn(propertyName: string, strict = false): {
 ...
 * @param propertyName the property name
 * @param strict defines whether or not to throw when the value is not an instance of DateTime
 * @returns the necessary sequelize configuration for the property to work with DATEONLY
 */
export function dateTimeColumn(propertyName: string, strict = false): {
    type: DataTypes.DATE,
    get(): DateTime | null;
    set(value: any): void;
};
